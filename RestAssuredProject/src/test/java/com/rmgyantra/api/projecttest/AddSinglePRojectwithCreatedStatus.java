...
public class AddSinglePRojectwithCreatedStatus extends BaseAPIClass{
	...
	public void addSingleproject() throws Throwable {
		...
		Project projObj = new Project("Deepak", "Airtel-6", "Created", 10);
        ...
        //verify business LAyer
		 Response resp = given()
					 ...
					 Assert.assertEquals(actProjectName, "Airtel-6");
					 Assert.assertEquals(actSucMsg, "Successfully Added");

					 dblib.executeQueryVerifyAndGetData("select * from project", 4, "Airtel-6");
					 dblib.executeQueryVerifyAndGetData("select * from project", 5, "Created");
	}
