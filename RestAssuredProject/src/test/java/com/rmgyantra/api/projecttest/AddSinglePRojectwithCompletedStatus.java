...
public class AddSinglePRojectwithCompletedStatus extends BaseAPIClass{
	
	
	@Test
	public void addSingleproject() throws Throwable {
		//create JSONObject using POJO class
		Project projObj = new Project("Deepak", "VI-5", "Completed", 10);
        ...
        //verify business LAyer
		 Response resp = given()
					 ...
					 Assert.assertEquals(actProjectName, "VI-5");
					 Assert.assertEquals(actSucMsg, "Successfully Added");
       
					 dblib.executeQueryVerifyAndGetData("select * from project", 4, "VI-5");
